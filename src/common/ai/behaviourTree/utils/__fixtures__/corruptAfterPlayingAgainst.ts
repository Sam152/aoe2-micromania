export const corruptAfterPlayingAgainst = {
  "0": {
    "nodes": [{
        ...
        "nodes": [
          ...
          },
          {
            "nodes": [{
              ...
              "nodeType": "action",
            }, { "nodes": [{ "type": "MERGE_GROUP", "params": {}, "nodeType": "action" }], "nodeType": "sequence" }],
            "nodeType": "sequence",
          },
          {
            "nodes": [{
        ...
        "nodes": [
          {
            "type": "SPLIT_GROUP",
            "params": {
              "splitGroupInto": { "type": "LITERAL", "value": "ONE", "dataType": "groupSize", "nodeType": "dataValue" },
            },
            "nodeType": "action",
          },
          { "nodes": [], "nodeType": "sequence" },
          {
            "nodes": [{
              ...
              "params": {
                ...
                "distance": { "type": "LITERAL", "value": 265, "dataType": "vectorMagnitude", "nodeType": "dataValue" },
              },
              "nodeType": "condition",
        ...
        "nodes": [{ "type": "MERGE_GROUP", "params": {}, "nodeType": "action" }, {
          ...
          "nodes": [{
            ...
            "params": {
              ...
              "distance": { "type": "LITERAL", "value": 65, "dataType": "vectorMagnitude", "nodeType": "dataValue" },
            },
            "nodeType": "condition",
          }],
          "nodeType": "selector",
          ...
          "nodes": [
            ...
            { "nodes": [], "nodeType": "sequence" },
            {
              ...
              "params": {
                ...
                "distance": { "type": "LITERAL", "value": 252, "dataType": "vectorMagnitude", "nodeType": "dataValue" },
              },
              "nodeType": "condition",
            },
            { "nodes": [], "nodeType": "sequence" },
            {
              ...
              "params": {
                ...
                "rightUnitCount": { "type": "LITERAL", "value": 3, "dataType": "unitCount", "nodeType": "dataValue" },
              },
              "nodeType": "condition",
            },
            {
          ...
          "params": {
            "forTicksAmount": {
              "type": "BLACKBOARD",
              "params": {
                "type": { "type": "LITERAL", "value": "ARROW", "dataType": "projectileType", "nodeType": "dataValue" },
              },
              "dataType": "tickCount",
              "nodeType": "dataValue",
              "blackboardKey": "opponentNextProjectileLandingInTicksTimeByType",
          ...
          "type": "SPLIT_GROUP",
          "params": {
            "splitGroupInto": { "type": "LITERAL", "value": "HALF", "dataType": "groupSize", "nodeType": "dataValue" },
          },
          "nodeType": "action",
        }, {
          "nodes": [{
