...
class SoundPlayer {
  ...
  private soundMap: SoundMap = {
    [Sound.ArrowFired]: {
      canOverlap: true,
      maxFromOneTick: 4,
      files: ["de/355890077", "de/144052104", "de/198714463", "de/911617070", "de/299825583", "de/1017455268"],
    },
    [Sound.SoldierMoved]: {
      canOverlap: false,
      files: ["hd/6275", "hd/6276", "hd/6277"],
    },
    [Sound.SoldierSelected]: {
      canOverlap: false,
      files: ["hd/6278", "hd/6279", "hd/6280"],
    },
    [Sound.SoldierAttack]: {
      canOverlap: false,
      files: ["hd/6271", "hd/6272", "hd/6273", "hd/6274"],
    },
    [Sound.SoldierFallen]: {
      canOverlap: true,
      maxFromOneTick: 3,
    ...
    [Sound.MangonelFired]: {
      canOverlap: true,
      maxFromOneTick: 4,
      files: ["de/1042749072", "de/1030796533", "de/37765250"],
    },
    [Sound.MangonelMoved]: {
      canOverlap: false,
      files: ["de/949628994", "de/450918993"],
    },
    ...
    [Sound.RocksLanded]: {
      canOverlap: true,
      files: ["de/1034594737", "de/270594082"],
    },
  };
